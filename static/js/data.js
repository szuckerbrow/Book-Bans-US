...
// dropdown menus removed from logic
...
// //Start to set up book clicks
// let bannedBookData = [];
// let bannedBookFull = [];

// // Load the JSON data containing the ban information
// d3.json("pen_13_most_banned.json").then(function(data) {
//   // Store the titles of banned books in the bannedBookData array
//   bannedBookFull = data;
//   bannedBookData = data.map(book => book.Title);
//   console.log("Line 11992", bannedBookData);
// });
...
//   var bookTitle = bannedBookData[bookNumber - 1];
//   console.log("Book " + bookNumber + " clicked!");

//   // Retrieve the book information using the book title
//   var bookInfo = bannedBookFull[bookNumber - 1]; 
//   console.log("Book info retrieved:", bookInfo);

//   // Check if the book is banned in any state
//   if (bookInfo.State) {
//       // Split the states if multiple states are banned
//       var bannedStates = bookInfo.State.split(", ");
//       bannedStates.forEach(state => {
//           console.log("Adding marker for state:", state);
//           // Add a marker on the map for each banned state
//           addMarker(state);
//       });
//   } 
// } 